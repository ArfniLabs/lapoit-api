...
public enum ErrorCode {
    ...
    // 사용자 관련
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER-404", "존재하는 사용자가 아닙니다."),
    ...
    // 게임 관련
    GAME_NOT_FOUND(HttpStatus.NOT_FOUND, "GAME-404", "해당 게임 테이블이 존재하지 않습니다."),
    GAME_NOT_STARTED(HttpStatus.BAD_REQUEST, "GAME-400", "해당 게임이 아직 시작되지 않았습니다."),
    GAME_ALREADY_START(HttpStatus.BAD_REQUEST, "GAME-400", "해당 게임이 이미 진행중입니다."),
    GAME_ALREADY_PAUSE(HttpStatus.BAD_REQUEST, "GAME-400", "해당 게임이 이미 일시정지중입니다."),
    ...
    GAME_ALREADY_JOINED(HttpStatus.BAD_REQUEST, "GAME-400", "해당 게임에 이미 참여중입니다."),
    USER_NOT_IN_GAME(HttpStatus.BAD_REQUEST, "GAME-400", "해당 게임에 참여중인 사용자가 아닙니다."),
    USER_ALREADY_OUT(HttpStatus.BAD_REQUEST, "GAME-400", "이미 게임에서 나간 상태입니다."),
